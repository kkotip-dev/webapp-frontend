        ...
        <>
            ...
            <div className="main-page-container">
                <div className="tabs-container">
                    <NavLink className={({ isActive }) => isActive ? "inline-icon active" : "inline-icon"} to="/"><LogoGraySvg /><span style={{ lineHeight: 1.1 }}>Расписание</span></NavLink>
                    <NavLink className={({ isActive }) => isActive ? "inline-icon active" : "inline-icon"} to="/journal"><MdChecklist /><span style={{ lineHeight: 1.2 }}>Журнал</span></NavLink>
